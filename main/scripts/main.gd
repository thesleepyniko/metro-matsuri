...
var screens = ["res://main/scenes/menu.tscn", "res://main/scenes/game.tscn", "res://main/scenes/failed.tscn", "res://main/scenes/new_page_confirm.tscn"]
enum enum_screens {menu=0, game=1, failed=2, new_page_confirm=3}
...
func _ready() -> void:
	...
	change_state(enum_screens.new_page_confirm)
